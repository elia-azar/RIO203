...
def collect_required_data():
    ...
    device_key = input("Please write \033[93mprovision device key\033[0m: ")
    config["provision_device_key"] = device_key if device_key else "f08xnbozcbn01g0c3c9x"
    device_secret = input("Please write \033[93mprovision device secret\033[0m: ")
    config["provision_device_secret"] = device_secret if device_secret else "bqp8allf27zdc1f3ow3b"
